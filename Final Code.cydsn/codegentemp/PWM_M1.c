...
void PWM_M1_Stop(void) 
{
    ...
    *******************************************************************************/
    ...
    {
        CY_SET_REG16(PWM_M1_COUNTER_LSB_PTR, counter);
    }
    ...
    *******************************************************************************/
    uint16 PWM_M1_ReadCounter(void) 
    {
        ...
        return (CY_GET_REG16(PWM_M1_CAPTURE_LSB_PTR));
    }
...
void PWM_M1_WritePeriod(uint16 period) 
{
    ...
    #else
        CY_SET_REG16(PWM_M1_PERIOD_LSB_PTR, period);
    #endif /* (PWM_M1_UsingFixedFunction) */
}
    ...
    *******************************************************************************/
                                       ...
                                       
    {
        ...
        #else
            CY_SET_REG16(PWM_M1_COMPARE1_LSB_PTR, compare);
        #endif /* (PWM_M1_UsingFixedFunction) */
            ...
            #else
                CY_SET_REG16(PWM_M1_COMPARE2_LSB_PTR, (compare + 1u));
            #endif /* (PWM_M1_UsingFixedFunction) */
    ...
    *******************************************************************************/
    ...
    {
        #if(PWM_M1_UsingFixedFunction)
            return ((uint16)CY_GET_REG16(PWM_M1_COMPARE1_LSB_PTR));
        #else
            return (CY_GET_REG16(PWM_M1_COMPARE1_LSB_PTR));
        #endif /* (PWM_M1_UsingFixedFunction) */
    }
    ...
    *******************************************************************************/
    ...
    {
        return (CY_GET_REG16(PWM_M1_COMPARE2_LSB_PTR));
    }
...
{
    #if(PWM_M1_UsingFixedFunction)
        return ((uint16)CY_GET_REG16(PWM_M1_PERIOD_LSB_PTR));
    #else
        return (CY_GET_REG16(PWM_M1_PERIOD_LSB_PTR));
    #endif /* (PWM_M1_UsingFixedFunction) */
}
