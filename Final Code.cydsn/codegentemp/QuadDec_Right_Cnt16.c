...
void QuadDec_Right_Cnt16_Init(void) 
{
            ...
            uint8 ctrl;
        #endif /* (!QuadDec_Right_Cnt16_UsingFixedFunction && !QuadDec_Right_Cnt16_ControlRegRemoved) */
        
        #if(!QuadDec_Right_Cnt16_UsingFixedFunction) 
            /* Interrupt State Backup for Critical Region*/
            uint8 QuadDec_Right_Cnt16_interruptState;
            ...
            #if (CY_PSOC5A)
                QuadDec_Right_Cnt16_CONTROL2 &= ((uint8)(~QuadDec_Right_Cnt16_CTRL_MODE_MASK));
            #endif /* (CY_PSOC5A) */
            #if (CY_PSOC3 || CY_PSOC5LP)
                QuadDec_Right_Cnt16_CONTROL3 &= ((uint8)(~QuadDec_Right_Cnt16_CTRL_MODE_MASK));                
            #endif /* (CY_PSOC3 || CY_PSOC5LP) */
            /* Check if One Shot mode is enabled i.e. RunMode !=0*/
            #if (QuadDec_Right_Cnt16_RunModeUsed != 0x0u)
                /* Set 3rd bit of Control register to enable one shot mode */
                QuadDec_Right_Cnt16_CONTROL |= QuadDec_Right_Cnt16_ONESHOT;
            #endif /* (QuadDec_Right_Cnt16_RunModeUsed != 0x0u) */
            
            /* Set the IRQ to use the status register interrupts */
            QuadDec_Right_Cnt16_CONTROL2 |= QuadDec_Right_Cnt16_CTRL2_IRQ_SEL;
            
            /* Clear and Set SYNCTC and SYNCCMP bits of RT1 register */
            QuadDec_Right_Cnt16_RT1 &= ((uint8)(~QuadDec_Right_Cnt16_RT1_MASK));
            QuadDec_Right_Cnt16_RT1 |= QuadDec_Right_Cnt16_SYNC;     
                    
            /*Enable DSI Sync all all inputs of the Timer*/
            QuadDec_Right_Cnt16_RT1 &= ((uint8)(~QuadDec_Right_Cnt16_SYNCDSI_MASK));
            QuadDec_Right_Cnt16_RT1 |= QuadDec_Right_Cnt16_SYNCDSI_EN;

        #else
            #if(!QuadDec_Right_Cnt16_ControlRegRemoved)
            /* Set the default compare mode defined in the parameter */
            ctrl = QuadDec_Right_Cnt16_CONTROL & ((uint8)(~QuadDec_Right_Cnt16_CTRL_CMPMODE_MASK));
            QuadDec_Right_Cnt16_CONTROL = ctrl | QuadDec_Right_Cnt16_DEFAULT_COMPARE_MODE;
            
            /* Set the default capture mode defined in the parameter */
            ctrl = QuadDec_Right_Cnt16_CONTROL & ((uint8)(~QuadDec_Right_Cnt16_CTRL_CAPMODE_MASK));
            
            #if( 0 != QuadDec_Right_Cnt16_CAPTURE_MODE_CONF)
                QuadDec_Right_Cnt16_CONTROL = ctrl | QuadDec_Right_Cnt16_DEFAULT_CAPTURE_MODE;
            #else
                QuadDec_Right_Cnt16_CONTROL = ctrl;
            #endif /* 0 != QuadDec_Right_Cnt16_CAPTURE_MODE */ 
        ...
        QuadDec_Right_Cnt16_SetInterruptMode(QuadDec_Right_Cnt16_INIT_INTERRUPTS_MASK);
            ...
            (void)QuadDec_Right_Cnt16_ReadStatusRegister();
            ...
            QuadDec_Right_Cnt16_interruptState = CyEnterCriticalSection();
            
            QuadDec_Right_Cnt16_STATUS_AUX_CTRL |= QuadDec_Right_Cnt16_STATUS_ACTL_INT_EN_MASK;
            
            /* Exit Critical Region*/
            CyExitCriticalSection(QuadDec_Right_Cnt16_interruptState);
...
void QuadDec_Right_Cnt16_Enable(void) 
{
    ...
    /* else make sure reset is clear */
        ...
        QuadDec_Right_Cnt16_CONTROL |= QuadDec_Right_Cnt16_CTRL_ENABLE;                
    #endif /* (!QuadDec_Right_Cnt16_ControlRegRemoved || QuadDec_Right_Cnt16_UsingFixedFunction) */
...
*
* Global variables:
*  QuadDec_Right_Cnt16_initVar: Is modified when this function is called for the  
...
void QuadDec_Right_Cnt16_Stop(void) 
{
    /* Disable Counter */
    #if(!QuadDec_Right_Cnt16_ControlRegRemoved || QuadDec_Right_Cnt16_UsingFixedFunction)
        QuadDec_Right_Cnt16_CONTROL &= ((uint8)(~QuadDec_Right_Cnt16_CTRL_ENABLE));        
    #endif /* (!QuadDec_Right_Cnt16_ControlRegRemoved || QuadDec_Right_Cnt16_UsingFixedFunction) */
    
    /* Globally disable the Fixed Function Block chosen */
    #if (QuadDec_Right_Cnt16_UsingFixedFunction)
        QuadDec_Right_Cnt16_GLOBAL_ENABLE &= ((uint8)(~QuadDec_Right_Cnt16_BLOCK_EN_MASK));
        QuadDec_Right_Cnt16_GLOBAL_STBY_ENABLE &= ((uint8)(~QuadDec_Right_Cnt16_BLOCK_STBY_EN_MASK));
    #endif /* (QuadDec_Right_Cnt16_UsingFixedFunction) */
}
                                   ...
                                   
{
        ...
        CYASSERT (0u == (QuadDec_Right_Cnt16_GLOBAL_ENABLE & QuadDec_Right_Cnt16_BLOCK_EN_MASK));
...
uint16 QuadDec_Right_Cnt16_ReadCounter(void) 
{
    ...
    #if(QuadDec_Right_Cnt16_UsingFixedFunction)
		(void)CY_GET_REG16(QuadDec_Right_Cnt16_COUNTER_LSB_PTR);
	#else
		(void)CY_GET_REG8(QuadDec_Right_Cnt16_COUNTER_LSB_PTR_8BIT);
	#endif/* (QuadDec_Right_Cnt16_UsingFixedFunction) */
    
    /* Read the data from the FIFO (or capture register for Fixed Function)*/
    #if(QuadDec_Right_Cnt16_UsingFixedFunction)
        return ((uint16)CY_GET_REG16(QuadDec_Right_Cnt16_STATICCOUNT_LSB_PTR));
    #else
...
{
    #if(QuadDec_Right_Cnt16_UsingFixedFunction)
        return ((uint16)CY_GET_REG16(QuadDec_Right_Cnt16_PERIOD_LSB_PTR));
    #else
...
void QuadDec_Right_Cnt16_SetCompareMode(uint8 compareMode) 
{
    ...
    QuadDec_Right_Cnt16_CONTROL &= ((uint8)(~QuadDec_Right_Cnt16_CTRL_CMPMODE_MASK));
    
    /* Write the new setting */
    QuadDec_Right_Cnt16_CONTROL |= compareMode;
}
...
void QuadDec_Right_Cnt16_SetCaptureMode(uint8 captureMode) 
{
    ...
    QuadDec_Right_Cnt16_CONTROL &= ((uint8)(~QuadDec_Right_Cnt16_CTRL_CAPMODE_MASK));
    
    /* Write the new setting */
    QuadDec_Right_Cnt16_CONTROL |= ((uint8)((uint8)captureMode << QuadDec_Right_Cnt16_CTRL_CAPMODE0_SHIFT));
}
...
void QuadDec_Right_Cnt16_ClearFIFO(void) 
{
    ...
    while(0u != (QuadDec_Right_Cnt16_ReadStatusRegister() & QuadDec_Right_Cnt16_STATUS_FIFONEMP))
    {
        (void)QuadDec_Right_Cnt16_ReadCapture();
    }
