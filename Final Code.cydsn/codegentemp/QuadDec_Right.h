...
#define QuadDec_Right_COUNTER_SIZE_8_BIT         (8u)
#define QuadDec_Right_COUNTER_SIZE_16_BIT        (16u)
#define QuadDec_Right_COUNTER_SIZE_32_BIT        (32u)
...
extern uint8 QuadDec_Right_initVar;
...
#define QuadDec_Right_COUNTER_RESOLUTION         (4u)
...
#if (QuadDec_Right_COUNTER_SIZE == QuadDec_Right_COUNTER_SIZE_32_BIT)
    #define QuadDec_Right_ISR_NUMBER             ((uint8) QuadDec_Right_isr__INTC_NUMBER)
    #define QuadDec_Right_ISR_PRIORITY           ((uint8) QuadDec_Right_isr__INTC_PRIOR_NUM)
#endif /* QuadDec_Right_COUNTER_SIZE == QuadDec_Right_COUNTER_SIZE_32_BIT */
...
***************************************/
    ...
    */
    ...
    #define QuadDec_Right_COUNTER_MAX_VALUE     (0x7FFFu)
#endif /* QuadDec_Right_COUNTER_SIZE == QuadDec_Right_COUNTER_SIZE_8_BIT */
...
#define QuadDec_Right_COUNTER_OVERFLOW           ((uint8) (0x01u << QuadDec_Right_COUNTER_OVERFLOW_SHIFT))
#define QuadDec_Right_COUNTER_UNDERFLOW          ((uint8) (0x01u << QuadDec_Right_COUNTER_UNDERFLOW_SHIFT))
#define QuadDec_Right_COUNTER_RESET              ((uint8) (0x01u << QuadDec_Right_COUNTER_RESET_SHIFT))
#define QuadDec_Right_INVALID_IN                 ((uint8) (0x01u << QuadDec_Right_INVALID_IN_SHIFT))

#define QuadDec_Right_INTERRUPTS_ENABLE_SHIFT    (0x04u)
#define QuadDec_Right_INTERRUPTS_ENABLE          ((uint8)(0x01u << QuadDec_Right_INTERRUPTS_ENABLE_SHIFT))
