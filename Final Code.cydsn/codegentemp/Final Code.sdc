...
# Date: Fri, 15 Sep 2017 05:56:13 GMT
#set_units -time ns
...
create_generated_clock -name {UClock} -source [get_pins {ClockBlock/clk_sync}] -edges {1 25 49} [list [get_pins {ClockBlock/dclk_glb_2}]]
create_clock -name {UClock(fixed-function)} -period 1000 -waveform {0 41.6666666666667} [get_pins {ClockBlock/dclk_glb_ff_2}]
