...
extern uint8 QuadDec_Left_Cnt16_initVar;
...
/* Error message for removed QuadDec_Left_Cnt16_CounterUDB_sCTRLReg_ctrlreg through optimization */
#ifdef QuadDec_Left_Cnt16_CounterUDB_sCTRLReg_ctrlreg__REMOVED
    #error Counter_v3_0 detected with a constant 0 for the enable, a \
                                constant 0 for the count or constant 1 for \
                                the reset. This will prevent the component from\
                                operating.
#endif /* QuadDec_Left_Cnt16_CounterUDB_sCTRLReg_ctrlreg__REMOVED */
...
#define QuadDec_Left_Cnt16_GetInterruptSource() QuadDec_Left_Cnt16_ReadStatusRegister()
#if(!QuadDec_Left_Cnt16_ControlRegRemoved)
    uint8   QuadDec_Left_Cnt16_ReadControlRegister(void) ;
    void    QuadDec_Left_Cnt16_WriteControlRegister(uint8 control) \
        ;
#endif /* (!QuadDec_Left_Cnt16_ControlRegRemoved) */
#if (!(QuadDec_Left_Cnt16_UsingFixedFunction && (CY_PSOC5A)))
    void    QuadDec_Left_Cnt16_WriteCounter(uint16 counter) \
            ; 
#endif /* (!(QuadDec_Left_Cnt16_UsingFixedFunction && (CY_PSOC5A))) */
...
#define QuadDec_Left_Cnt16_CMP_MODE_LT 1u
#define QuadDec_Left_Cnt16_CMP_MODE_LTE 2u
#define QuadDec_Left_Cnt16_CMP_MODE_EQ 0u
#define QuadDec_Left_Cnt16_CMP_MODE_GT 3u
#define QuadDec_Left_Cnt16_CMP_MODE_GTE 4u
#define QuadDec_Left_Cnt16_CMP_MODE_SOFTWARE_CONTROLLED 5u
...
/* Enumerated Type Counter_CompareModes */
#define QuadDec_Left_Cnt16_CAP_MODE_NONE 0u
#define QuadDec_Left_Cnt16_CAP_MODE_RISE 1u
#define QuadDec_Left_Cnt16_CAP_MODE_FALL 2u
#define QuadDec_Left_Cnt16_CAP_MODE_BOTH 3u
#define QuadDec_Left_Cnt16_CAP_MODE_SOFTWARE_CONTROLLED 4u


/***************************************
 *  Initialization Values
 **************************************/
#define QuadDec_Left_Cnt16_CAPTURE_MODE_CONF       0u
#define QuadDec_Left_Cnt16_INIT_PERIOD_VALUE       32768u
#define QuadDec_Left_Cnt16_INIT_COUNTER_VALUE      32768u
#if (QuadDec_Left_Cnt16_UsingFixedFunction)
#define QuadDec_Left_Cnt16_INIT_INTERRUPTS_MASK    ((uint8)((uint8)0u << QuadDec_Left_Cnt16_STATUS_ZERO_INT_EN_MASK_SHIFT))
#else
#define QuadDec_Left_Cnt16_INIT_COMPARE_VALUE      32768u
#define QuadDec_Left_Cnt16_INIT_INTERRUPTS_MASK ((uint8)((uint8)0u << QuadDec_Left_Cnt16_STATUS_ZERO_INT_EN_MASK_SHIFT) | \
        ((uint8)((uint8)0u << QuadDec_Left_Cnt16_STATUS_CAPTURE_INT_EN_MASK_SHIFT)) | \
        ((uint8)((uint8)0u << QuadDec_Left_Cnt16_STATUS_CMP_INT_EN_MASK_SHIFT)) | \
        ((uint8)((uint8)0u << QuadDec_Left_Cnt16_STATUS_OVERFLOW_INT_EN_MASK_SHIFT)) | \
        ((uint8)((uint8)0u << QuadDec_Left_Cnt16_STATUS_UNDERFLOW_INT_EN_MASK_SHIFT)))
#define QuadDec_Left_Cnt16_DEFAULT_COMPARE_MODE    0u

#if( 0 != QuadDec_Left_Cnt16_CAPTURE_MODE_CONF)
    #define QuadDec_Left_Cnt16_DEFAULT_CAPTURE_MODE    ((uint8)((uint8)0u << QuadDec_Left_Cnt16_CTRL_CAPMODE0_SHIFT))
#else    
    #define QuadDec_Left_Cnt16_DEFAULT_CAPTURE_MODE    (0u )
#endif /* ( 0 != QuadDec_Left_Cnt16_CAPTURE_MODE_CONF) */
 ...
 *************************************/
    ...
    #define QuadDec_Left_Cnt16_RT1                 (*(reg8 *) QuadDec_Left_Cnt16_CounterHW__RT1)
    #define QuadDec_Left_Cnt16_RT1_PTR             ( (reg8 *) QuadDec_Left_Cnt16_CounterHW__RT1)
#else
    
    #if (QuadDec_Left_Cnt16_Resolution <= 8u) /* 8-bit Counter */
    
        #define QuadDec_Left_Cnt16_STATICCOUNT_LSB     (*(reg8 *) \
            QuadDec_Left_Cnt16_CounterUDB_sC16_counterdp_u0__F0_REG )
        #define QuadDec_Left_Cnt16_STATICCOUNT_LSB_PTR ( (reg8 *) \
            QuadDec_Left_Cnt16_CounterUDB_sC16_counterdp_u0__F0_REG )
        #define QuadDec_Left_Cnt16_PERIOD_LSB          (*(reg8 *) \
            QuadDec_Left_Cnt16_CounterUDB_sC16_counterdp_u0__D0_REG )
        #define QuadDec_Left_Cnt16_PERIOD_LSB_PTR      ( (reg8 *) \
            QuadDec_Left_Cnt16_CounterUDB_sC16_counterdp_u0__D0_REG )
        #define QuadDec_Left_Cnt16_COMPARE_LSB         (*(reg8 *) \
            QuadDec_Left_Cnt16_CounterUDB_sC16_counterdp_u0__D1_REG )
        #define QuadDec_Left_Cnt16_COMPARE_LSB_PTR     ( (reg8 *) \
            QuadDec_Left_Cnt16_CounterUDB_sC16_counterdp_u0__D1_REG )
        #define QuadDec_Left_Cnt16_COUNTER_LSB         (*(reg8 *) \
            QuadDec_Left_Cnt16_CounterUDB_sC16_counterdp_u0__A0_REG )  
        #define QuadDec_Left_Cnt16_COUNTER_LSB_PTR     ( (reg8 *)\
            QuadDec_Left_Cnt16_CounterUDB_sC16_counterdp_u0__A0_REG )
    
    #elif(QuadDec_Left_Cnt16_Resolution <= 16u) /* 16-bit Counter */
            ...
            #define QuadDec_Left_Cnt16_STATICCOUNT_LSB     (*(reg16 *) \
                QuadDec_Left_Cnt16_CounterUDB_sC16_counterdp_u0__16BIT_F0_REG )
            #define QuadDec_Left_Cnt16_STATICCOUNT_LSB_PTR ( (reg16 *) \
                QuadDec_Left_Cnt16_CounterUDB_sC16_counterdp_u0__16BIT_F0_REG )
            #define QuadDec_Left_Cnt16_PERIOD_LSB          (*(reg16 *) \
                QuadDec_Left_Cnt16_CounterUDB_sC16_counterdp_u0__16BIT_D0_REG )
            #define QuadDec_Left_Cnt16_PERIOD_LSB_PTR      ( (reg16 *) \
                QuadDec_Left_Cnt16_CounterUDB_sC16_counterdp_u0__16BIT_D0_REG )
            #define QuadDec_Left_Cnt16_COMPARE_LSB         (*(reg16 *) \
                QuadDec_Left_Cnt16_CounterUDB_sC16_counterdp_u0__16BIT_D1_REG )
            #define QuadDec_Left_Cnt16_COMPARE_LSB_PTR     ( (reg16 *) \
                QuadDec_Left_Cnt16_CounterUDB_sC16_counterdp_u0__16BIT_D1_REG )
            #define QuadDec_Left_Cnt16_COUNTER_LSB         (*(reg16 *) \
                QuadDec_Left_Cnt16_CounterUDB_sC16_counterdp_u0__16BIT_A0_REG )  
            #define QuadDec_Left_Cnt16_COUNTER_LSB_PTR     ( (reg16 *)\
                QuadDec_Left_Cnt16_CounterUDB_sC16_counterdp_u0__16BIT_A0_REG )
        #endif /* CY_PSOC3 */   
    #elif(QuadDec_Left_Cnt16_Resolution <= 24u) /* 24-bit Counter */
        
        #define QuadDec_Left_Cnt16_STATICCOUNT_LSB     (*(reg32 *) \
            QuadDec_Left_Cnt16_CounterUDB_sC16_counterdp_u0__F0_REG )
        #define QuadDec_Left_Cnt16_STATICCOUNT_LSB_PTR ( (reg32 *) \
            QuadDec_Left_Cnt16_CounterUDB_sC16_counterdp_u0__F0_REG )
        #define QuadDec_Left_Cnt16_PERIOD_LSB          (*(reg32 *) \
            QuadDec_Left_Cnt16_CounterUDB_sC16_counterdp_u0__D0_REG )
        #define QuadDec_Left_Cnt16_PERIOD_LSB_PTR      ( (reg32 *) \
            QuadDec_Left_Cnt16_CounterUDB_sC16_counterdp_u0__D0_REG )
        #define QuadDec_Left_Cnt16_COMPARE_LSB         (*(reg32 *) \
            QuadDec_Left_Cnt16_CounterUDB_sC16_counterdp_u0__D1_REG )
        #define QuadDec_Left_Cnt16_COMPARE_LSB_PTR     ( (reg32 *) \
            QuadDec_Left_Cnt16_CounterUDB_sC16_counterdp_u0__D1_REG )
        #define QuadDec_Left_Cnt16_COUNTER_LSB         (*(reg32 *) \
            QuadDec_Left_Cnt16_CounterUDB_sC16_counterdp_u0__A0_REG )  
        #define QuadDec_Left_Cnt16_COUNTER_LSB_PTR     ( (reg32 *)\
            QuadDec_Left_Cnt16_CounterUDB_sC16_counterdp_u0__A0_REG )
            ...
            #define QuadDec_Left_Cnt16_STATICCOUNT_LSB     (*(reg32 *) \
                QuadDec_Left_Cnt16_CounterUDB_sC16_counterdp_u0__32BIT_F0_REG )
            #define QuadDec_Left_Cnt16_STATICCOUNT_LSB_PTR ( (reg32 *) \
                QuadDec_Left_Cnt16_CounterUDB_sC16_counterdp_u0__32BIT_F0_REG )
            #define QuadDec_Left_Cnt16_PERIOD_LSB          (*(reg32 *) \
                QuadDec_Left_Cnt16_CounterUDB_sC16_counterdp_u0__32BIT_D0_REG )
            #define QuadDec_Left_Cnt16_PERIOD_LSB_PTR      ( (reg32 *) \
                QuadDec_Left_Cnt16_CounterUDB_sC16_counterdp_u0__32BIT_D0_REG )
            #define QuadDec_Left_Cnt16_COMPARE_LSB         (*(reg32 *) \
                QuadDec_Left_Cnt16_CounterUDB_sC16_counterdp_u0__32BIT_D1_REG )
            #define QuadDec_Left_Cnt16_COMPARE_LSB_PTR     ( (reg32 *) \
                QuadDec_Left_Cnt16_CounterUDB_sC16_counterdp_u0__32BIT_D1_REG )
            #define QuadDec_Left_Cnt16_COUNTER_LSB         (*(reg32 *) \
                QuadDec_Left_Cnt16_CounterUDB_sC16_counterdp_u0__32BIT_A0_REG )  
            #define QuadDec_Left_Cnt16_COUNTER_LSB_PTR     ( (reg32 *)\
                QuadDec_Left_Cnt16_CounterUDB_sC16_counterdp_u0__32BIT_A0_REG )
        #endif /* CY_PSOC3 || CY_PSOC5 */   
    #endif

	#define QuadDec_Left_Cnt16_COUNTER_LSB_PTR_8BIT     ( (reg8 *)\
                QuadDec_Left_Cnt16_CounterUDB_sC16_counterdp_u0__A0_REG )
    ...
    #define QuadDec_Left_Cnt16_AUX_CONTROLDP0_PTR \
       ...
       #define QuadDec_Left_Cnt16_AUX_CONTROLDP1_PTR \
           ( (reg8 *) QuadDec_Left_Cnt16_CounterUDB_sC16_counterdp_u1__DP_AUX_CTL_REG)
    #endif /* (QuadDec_Left_Cnt16_Resolution == 16 || QuadDec_Left_Cnt16_Resolution == 24 || QuadDec_Left_Cnt16_Resolution == 32) */
       ...
       #define QuadDec_Left_Cnt16_AUX_CONTROLDP2_PTR \
           ( (reg8 *) QuadDec_Left_Cnt16_CounterUDB_sC16_counterdp_u2__DP_AUX_CTL_REG)
    #endif /* (QuadDec_Left_Cnt16_Resolution == 24 || QuadDec_Left_Cnt16_Resolution == 32) */
       ...
       #define QuadDec_Left_Cnt16_AUX_CONTROLDP3_PTR \
           ( (reg8 *) QuadDec_Left_Cnt16_CounterUDB_sC16_counterdp_u3__DP_AUX_CTL_REG)
    #endif /* (QuadDec_Left_Cnt16_Resolution == 32) */
    ...
    ********************************/
    ...
    #define QuadDec_Left_Cnt16_ONESHOT_SHIFT          0x02u
    /* Control Register Bit Masks */
    #define QuadDec_Left_Cnt16_CTRL_ENABLE            ((uint8)((uint8)0x01u << QuadDec_Left_Cnt16_CTRL_ENABLE_SHIFT))         
    #define QuadDec_Left_Cnt16_ONESHOT                ((uint8)((uint8)0x01u << QuadDec_Left_Cnt16_ONESHOT_SHIFT))
    ...
    /* Set the mask for run mode */
        ...
        #define QuadDec_Left_Cnt16_CTRL_MODE_MASK         ((uint8)((uint8)0x07u << QuadDec_Left_Cnt16_CTRL_MODE_SHIFT))
    #endif /* (CY_PSOC5A) */
    #if (CY_PSOC3 || CY_PSOC5LP)
        /* Use CFG2 Mode bits to set run mode */
        #define QuadDec_Left_Cnt16_CTRL_MODE_SHIFT        0x00u    
        #define QuadDec_Left_Cnt16_CTRL_MODE_MASK         ((uint8)((uint8)0x03u << QuadDec_Left_Cnt16_CTRL_MODE_SHIFT))
    #endif /* (CY_PSOC3 || CY_PSOC5LP) */
    /* Set the mask for interrupt (raw/status register) */
    #define QuadDec_Left_Cnt16_CTRL2_IRQ_SEL_SHIFT     0x00u
    #define QuadDec_Left_Cnt16_CTRL2_IRQ_SEL          ((uint8)((uint8)0x01u << QuadDec_Left_Cnt16_CTRL2_IRQ_SEL_SHIFT))     
    ...
    #define QuadDec_Left_Cnt16_STATUS_ZERO            ((uint8)((uint8)0x01u << QuadDec_Left_Cnt16_STATUS_ZERO_SHIFT))

    /* Status Register Interrupt Bit Masks*/
    #define QuadDec_Left_Cnt16_STATUS_ZERO_INT_EN_MASK       ((uint8)((uint8)QuadDec_Left_Cnt16_STATUS_ZERO >> 0x04u))
    
    /*RT1 Synch Constants: Applicable for PSoC3 and PSoC5LP */
    #define QuadDec_Left_Cnt16_RT1_SHIFT            0x04u
    #define QuadDec_Left_Cnt16_RT1_MASK             ((uint8)((uint8)0x03u << QuadDec_Left_Cnt16_RT1_SHIFT))  /* Sync TC and CMP bit masks */
    #define QuadDec_Left_Cnt16_SYNC                 ((uint8)((uint8)0x03u << QuadDec_Left_Cnt16_RT1_SHIFT))
    #define QuadDec_Left_Cnt16_SYNCDSI_SHIFT        0x00u
    #define QuadDec_Left_Cnt16_SYNCDSI_MASK         ((uint8)((uint8)0x0Fu << QuadDec_Left_Cnt16_SYNCDSI_SHIFT)) /* Sync all DSI inputs */
    #define QuadDec_Left_Cnt16_SYNCDSI_EN           ((uint8)((uint8)0x0Fu << QuadDec_Left_Cnt16_SYNCDSI_SHIFT)) /* Sync all DSI inputs */
    
#else /* !QuadDec_Left_Cnt16_UsingFixedFunction */
    #define QuadDec_Left_Cnt16_STATUS               (* (reg8 *) QuadDec_Left_Cnt16_CounterUDB_sSTSReg_stsreg__STATUS_REG )
    #define QuadDec_Left_Cnt16_STATUS_PTR           (  (reg8 *) QuadDec_Left_Cnt16_CounterUDB_sSTSReg_stsreg__STATUS_REG )
    #define QuadDec_Left_Cnt16_STATUS_MASK          (* (reg8 *) QuadDec_Left_Cnt16_CounterUDB_sSTSReg_stsreg__MASK_REG )
    #define QuadDec_Left_Cnt16_STATUS_MASK_PTR      (  (reg8 *) QuadDec_Left_Cnt16_CounterUDB_sSTSReg_stsreg__MASK_REG )
    #define QuadDec_Left_Cnt16_STATUS_AUX_CTRL      (*(reg8 *) QuadDec_Left_Cnt16_CounterUDB_sSTSReg_stsreg__STATUS_AUX_CTL_REG)
    #define QuadDec_Left_Cnt16_STATUS_AUX_CTRL_PTR  ( (reg8 *) QuadDec_Left_Cnt16_CounterUDB_sSTSReg_stsreg__STATUS_AUX_CTL_REG)
    ...
    ********************************/
    ...
    /* Control Register Bit Masks */
    #define QuadDec_Left_Cnt16_CTRL_CMPMODE_MASK      0x07u 
    #define QuadDec_Left_Cnt16_CTRL_CAPMODE_MASK      0x03u  
    #define QuadDec_Left_Cnt16_CTRL_RESET             ((uint8)((uint8)0x01u << QuadDec_Left_Cnt16_CTRL_RESET_SHIFT))  
    #define QuadDec_Left_Cnt16_CTRL_ENABLE            ((uint8)((uint8)0x01u << QuadDec_Left_Cnt16_CTRL_ENABLE_SHIFT)) 
    ...
    /* Status Register Bit Masks */                
    #define QuadDec_Left_Cnt16_STATUS_CMP             ((uint8)((uint8)0x01u << QuadDec_Left_Cnt16_STATUS_CMP_SHIFT))  
    #define QuadDec_Left_Cnt16_STATUS_ZERO            ((uint8)((uint8)0x01u << QuadDec_Left_Cnt16_STATUS_ZERO_SHIFT)) 
    #define QuadDec_Left_Cnt16_STATUS_OVERFLOW        ((uint8)((uint8)0x01u << QuadDec_Left_Cnt16_STATUS_OVERFLOW_SHIFT)) 
    #define QuadDec_Left_Cnt16_STATUS_UNDERFLOW       ((uint8)((uint8)0x01u << QuadDec_Left_Cnt16_STATUS_UNDERFLOW_SHIFT)) 
    #define QuadDec_Left_Cnt16_STATUS_CAPTURE         ((uint8)((uint8)0x01u << QuadDec_Left_Cnt16_STATUS_CAPTURE_SHIFT)) 
    #define QuadDec_Left_Cnt16_STATUS_FIFOFULL        ((uint8)((uint8)0x01u << QuadDec_Left_Cnt16_STATUS_FIFOFULL_SHIFT))
    #define QuadDec_Left_Cnt16_STATUS_FIFONEMP        ((uint8)((uint8)0x01u << QuadDec_Left_Cnt16_STATUS_FIFONEMP_SHIFT))
