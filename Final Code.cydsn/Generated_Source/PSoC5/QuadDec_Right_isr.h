...
*******************************************************************************/
#if !defined(CY_ISR_QuadDec_Right_isr_H)
#define CY_ISR_QuadDec_Right_isr_H
...
#define QuadDec_Right_isr_INTC_VECTOR            ((reg32 *) QuadDec_Right_isr__INTC_VECT)
...
#define QuadDec_Right_isr_INTC_SET_EN            ((reg32 *) QuadDec_Right_isr__INTC_SET_EN_REG)

/* Address of the INTC.CLR_EN[x] register to bit clear the QuadDec_Right_isr interrupt. */
#define QuadDec_Right_isr_INTC_CLR_EN            ((reg32 *) QuadDec_Right_isr__INTC_CLR_EN_REG)

/* Address of the INTC.SET_PD[x] register to set the QuadDec_Right_isr interrupt state to pending. */
#define QuadDec_Right_isr_INTC_SET_PD            ((reg32 *) QuadDec_Right_isr__INTC_SET_PD_REG)

/* Address of the INTC.CLR_PD[x] register to clear the QuadDec_Right_isr interrupt. */
#define QuadDec_Right_isr_INTC_CLR_PD            ((reg32 *) QuadDec_Right_isr__INTC_CLR_PD_REG)


#endif /* CY_ISR_QuadDec_Right_isr_H */
